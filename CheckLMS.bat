...
rem     06-Feb-2023:
rem        - Check: not 2.5.824 AND not 2.6.849 AND not 2.7.872 AND less or equal than 2.7.871  --> DEPRECATED (per Jan-2023) (Fix: Defect 2197309)
rem
rem     27-Feb-2023:
rem        - support ecmcommonutil.exe V1.29 (Fix: Defect 2226119)
rem        - execute ecmcommonutil V1.25 and V1.28 only when /extended flag is set.
rem
rem     SCRIPT USAGE:
...
rem  
rem
set LMS_SCRIPT_VERSION="CheckLMS Script 27-Feb-2023"
set LMS_SCRIPT_BUILD=20230227
...
if not defined LMS_SKIPDOWNLOAD (
	...
	if "!ConnectionTestStatus!" == "Passed" (
		...
		if defined LMS_DOWNLOAD_PATH (
			...
			rem Download tool "ecmcommonutil_x64_n6.exe" V1.23 (=ecmcommonutil_x64_n6_V1.23.exe) (from Flexera) to read-out host id's
			IF NOT EXIST "!LMS_DOWNLOAD_PATH!\ecmcommonutil_x64_n6_V1.23.exe" (
				echo     Download ecmcommonutil app: !LMS_DOWNLOAD_PATH!\ecmcommonutil_x64_n6_V1.23.exe
				echo Download ecmcommonutil app: !LMS_DOWNLOAD_PATH!\ecmcommonutil_x64_n6_V1.23.exe                                     >> !REPORT_LOGFILE! 2>&1
				powershell -Command "(New-Object Net.WebClient).DownloadFile('!CHECKLMS_EXTERNAL_SHARE!lms/FNP/ecmcommonutil_x64_n6_V1.23.exe', '!LMS_DOWNLOAD_PATH!\ecmcommonutil_x64_n6_V1.23.exe')"   >> !REPORT_LOGFILE! 2>&1
			)
			...
			IF NOT EXIST "!LMS_DOWNLOAD_PATH!\ECMCommonUtil_DevMar2022.exe" (
			...
			IF NOT EXIST "!LMS_DOWNLOAD_PATH!\ecmcommonutil_V1.29.exe" (
				echo     Download ecmcommonutil app [V1.29]: !LMS_DOWNLOAD_PATH!\ecmcommonutil_V1.29.exe
				echo Download ecmcommonutil app [V1.29]: '!CHECKLMS_EXTERNAL_SHARE!lms/FNP/ecmcommonutil_V1.29.exe'                     >> !REPORT_LOGFILE! 2>&1
				powershell -Command "(New-Object Net.WebClient).DownloadFile('!CHECKLMS_EXTERNAL_SHARE!lms/FNP/ecmcommonutil_V1.29.exe', '!LMS_DOWNLOAD_PATH!\ecmcommonutil_V1.29.exe')"   >> !REPORT_LOGFILE! 2>&1
			)
...
if not defined LMS_SKIPWMIC (
	...
	if exist "!LMS_DOWNLOAD_PATH!\WmiRead.exe" (
		if defined VC_REDIST_VERSION (
			...
			echo No VC++ redistributable package installed, cannot read-out wmic information with WmiRead.exe.           >> !REPORT_LOGFILE! 2>&1
		)
	) else (
	...
	echo ---------------- wmic os get locale, oslanguage, codeset, DataExecutionPrevention_Available, DataExecutionPrevention_SupportPolicy                  >> !REPORT_LOGFILE! 2>&1
	echo     wmic os get locale, oslanguage, codeset, DataExecutionPrevention_Available, DataExecutionPrevention_SupportPolicy
	echo see http://www.robvanderwoude.com/languagecodes.php                                                                 >> !REPORT_LOGFILE! 2>&1
	wmic /output:!REPORT_WMIC_LOGFILE! os get locale, oslanguage, codeset, DataExecutionPrevention_Available, DataExecutionPrevention_SupportPolicy /format:list    >> !REPORT_LOGFILE! 2>&1
	type !REPORT_WMIC_LOGFILE!                                                                                               >> !REPORT_LOGFILE! 2>&1
	wmic /output:!CHECKLMS_REPORT_LOG_PATH!\wmicos_fullList.txt os get /format:list                                          >> !REPORT_LOGFILE! 2>&1
	echo -------------------------------------------------------                                                             >> !REPORT_LOGFILE! 2>&1
...
if not defined LMS_SKIPLMS (
	...
	IF EXIST "!ProgramFiles!\Siemens\LMS\scripts\lmu.psc1" (
		echo LMS System ID: [read with LMU PowerShell command: get-lms -SystemId]                                                >> !REPORT_LOGFILE! 2>&1
		echo     LMS System ID: [read with LMU PowerShell command: get-lms -SystemId]
		...
		echo -------------------------------------------------------                                                             >> !REPORT_LOGFILE! 2>&1
		echo LMS Deployment: [read with LMU PowerShell command: get-lms -Deployment]                                             >> !REPORT_LOGFILE! 2>&1
		echo     LMS Deployment: [read with LMU PowerShell command: get-lms -Deployment]
		...
		echo -------------------------------------------------------                                                             >> !REPORT_LOGFILE! 2>&1
		echo LMS Application Mode: [read with LMU PowerShell command: get-lms -AppMode]                                          >> !REPORT_LOGFILE! 2>&1
		echo     LMS Application Mode: [read with LMU PowerShell command: get-lms -AppMode]
		...
		echo -------------------------------------------------------                                                             >> !REPORT_LOGFILE! 2>&1
		echo LMS Is Virtual Machine: [read with LMU PowerShell command: get-lms -IsVM]                                           >> !REPORT_LOGFILE! 2>&1
		echo     LMS Is Virtual Machine: [read with LMU PowerShell command: get-lms -IsVM]
		...
		echo -------------------------------------------------------                                                             >> !REPORT_LOGFILE! 2>&1
		echo LMS CSID: [read with LMU PowerShell command: get-lms -Csid]                                                         >> !REPORT_LOGFILE! 2>&1
		echo     LMS CSID: [read with LMU PowerShell command: get-lms -Csid]
		...
		echo -------------------------------------------------------                                                             >> !REPORT_LOGFILE! 2>&1
		echo LMS Default Family: [read with LMU PowerShell command: Get-Lms -DefaultFamily]                                      >> !REPORT_LOGFILE! 2>&1
		echo     LMS Default Family: [read with LMU PowerShell command: Get-Lms -DefaultFamily]
		if /I !LMS_BUILD_VERSION! GEQ 839 (
			echo powershell -PSConsoleFile "!ProgramFiles!\Siemens\LMS\scripts\lmu.psc1" -command "& {Get-Lms -DefaultFamily}"   >> !REPORT_LOGFILE! 2>&1
			powershell -PSConsoleFile "!ProgramFiles!\Siemens\LMS\scripts\lmu.psc1" -command "& {Get-Lms -DefaultFamily}"        >> !REPORT_LOGFILE! 2>&1 
			for /f %%i in ('powershell -PSConsoleFile "!ProgramFiles!\Siemens\LMS\scripts\lmu.psc1" -command "& {Get-Lms -DefaultFamily}"') do set LMS_PS_DEFAULTFAMILY=%%i >> !REPORT_LOGFILE! 2>&1
		...
		echo     LMS Culture Id: [read with LMU PowerShell command: get-lms -CultureId]
		...
		echo -------------------------------------------------------                                                             >> !REPORT_LOGFILE! 2>&1
		echo LMS Last Used Directory: [read with LMU PowerShell command: get-lms -LastDir]                                       >> !REPORT_LOGFILE! 2>&1
		echo     LMS Last Used Directory: [read with LMU PowerShell command: get-lms -LastDir]
		...
		echo -------------------------------------------------------                                                             >> !REPORT_LOGFILE! 2>&1
		echo LMS Data Storage Directory: [read with LMU PowerShell command: get-lms -DsPath]                                     >> !REPORT_LOGFILE! 2>&1
		echo     LMS Data Storage Directory: [read with LMU PowerShell command: get-lms -DsPath]
		...
		echo -------------------------------------------------------                                                             >> !REPORT_LOGFILE! 2>&1
		echo LMS Certificate Directory: [read with LMU PowerShell command: get-lms -CertPath]                                    >> !REPORT_LOGFILE! 2>&1
		echo     LMS Certificate Directory: [read with LMU PowerShell command: get-lms -CertPath]
		...
		echo -------------------------------------------------------                                                             >> !REPORT_LOGFILE! 2>&1
		echo LMS Transfer Directory: [read with LMU PowerShell command: get-lms -TransferFolder]                                 >> !REPORT_LOGFILE! 2>&1
		echo     LMS Transfer Directory: [read with LMU PowerShell command: get-lms -TransferFolder]
		...
		echo -------------------------------------------------------                                                             >> !REPORT_LOGFILE! 2>&1
		echo LMS Token, used to authenticate at FNO server: [read with LMU PowerShell command: get-lms -Token]                   >> !REPORT_LOGFILE! 2>&1
		echo     LMS Token, used to authenticate at FNO server: [read with LMU PowerShell command: get-lms -Token]
	...
	if defined LMS_LMUTOOL (
		"!LMS_LMUTOOL!" /check                                                                                                   >> !REPORT_LOGFILE! 2>&1
	) else (
		echo     LmuTool is not available with LMS !LMS_VERSION!, cannot perform operation.                                      >> !REPORT_LOGFILE! 2>&1 
	)
	echo Start at !DATE! !TIME! ....                                                                                             >> !REPORT_LOGFILE! 2>&1
	...
	if !ERRORLEVEL!==0 (
		...
		rem type !CHECKLMS_REPORT_LOG_PATH!\connection_test_dongledriverdiagnostics.txt                                          >> !REPORT_LOGFILE! 2>&1
	)
	echo -------------------------------------------------------                                                             >> !REPORT_LOGFILE! 2>&1
...
del !CHECKLMS_REPORT_LOG_PATH!\tmpStrRplc.ps1 >nul 2>&1
del !lms_ps_script1!                          >nul 2>&1
...
IF EXIST "!LMS_DOWNLOAD_PATH!\!ECMCOMMONUTIL_TOOL!" (
	...
	echo Current ECM values, collected with !ECMCOMMONUTIL_TOOL! V1.29 ...          >> !REPORT_LOGFILE! 2>&1
...
if defined LMS_EXTENDED_CONTENT (
	...
	echo Read host id's [using !ECMCOMMONUTIL_TOOL! V1.28] SKIPPED, start script with option '/extend' to enable extended content.         >> !REPORT_LOGFILE! 2>&1
)
echo ==============================================================================           >> !REPORT_LOGFILE! 2>&1
...
IF EXIST "!LMS_DOWNLOAD_PATH!\!ECMCOMMONUTIL_TOOL!" (
	...
	"!LMS_DOWNLOAD_PATH!\!ECMCOMMONUTIL_TOOL!" -l -f -d smbios                                     >  !CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_V1.27_smbios_Latest.txt 2>&1
	"!LMS_DOWNLOAD_PATH!\!ECMCOMMONUTIL_TOOL!" -l -f -d vm                                         >  !CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_V1.27_vm_Latest.txt 2>&1
	if exist "!CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_V1.27_smbios_Latest.txt" for /f "tokens=1,2 eol=@ delims==" %%A in ('type !CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_V1.27_smbios_Latest.txt ^|find /I "Smbios UUID"') do set "ECM_SMBIOS_UUID_5=%%B"
	if exist "!CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_V1.27_vm_Latest.txt"     for /f "tokens=1,2 eol=@ delims==:" %%A in ('type !CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_V1.27_vm_Latest.txt ^|findstr /I /B "FAMILY"') do if not "%%B" == " ERROR - Unavailable." set "ECM_VM_FAMILY_5=%%B"
	if exist "!CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_V1.27_vm_Latest.txt"     for /f "tokens=1,2 eol=@ delims==:" %%A in ('type !CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_V1.27_vm_Latest.txt ^|findstr /I /B "NAME"') do if not "%%B" == " ERROR - Unavailable." set "ECM_VM_NAME_5=%%B"
	if exist "!CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_V1.27_vm_Latest.txt"     for /f "tokens=1,2 eol=@ delims==:" %%A in ('type !CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_V1.27_vm_Latest.txt ^|findstr /I /B "UUID"') do if not "%%B" == " ERROR - Unavailable." set "ECM_VM_UUID_5=%%B"
	if exist "!CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_V1.27_vm_Latest.txt"     for /f "tokens=1,2 eol=@ delims==:" %%A in ('type !CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_V1.27_vm_Latest.txt ^|findstr /I /B "GENID"') do if not "%%B" == " ERROR - Unavailable." set "ECM_VM_GENID_5=%%B"
	
	echo Current ECM values, collected with !ECMCOMMONUTIL_TOOL! V1.27 ...          >> !REPORT_LOGFILE! 2>&1
	echo     ECM_VM_FAMILY=!ECM_VM_FAMILY_5! / ECM_VM_NAME=!ECM_VM_NAME_5! / ECM_VM_UUID=!ECM_VM_UUID_5! / ECM_SMBIOS_UUID=!ECM_SMBIOS_UUID_5! / ECM_VM_GENID=!ECM_VM_GENID_5!                      >> !REPORT_LOGFILE! 2>&1
	echo     ECM_VM_FAMILY=!ECM_VM_FAMILY_5! / ECM_VM_NAME=!ECM_VM_NAME_5! / ECM_VM_UUID=!ECM_VM_UUID_5! / ECM_SMBIOS_UUID=!ECM_SMBIOS_UUID_5! / ECM_VM_GENID=!ECM_VM_GENID_5!  at !DATE! / !TIME! / using !ECMCOMMONUTIL_TOOL! [V1.27] >> !REPORT_LOG_PATH!\VMECMID.txt 2>&1
	echo     ECM_VM_FAMILY=!ECM_VM_FAMILY_5! / ECM_VM_NAME=!ECM_VM_NAME_5! / ECM_VM_UUID=!ECM_VM_UUID_5! / ECM_SMBIOS_UUID=!ECM_SMBIOS_UUID_5! / ECM_VM_GENID=!ECM_VM_GENID_5!  at !DATE! / !TIME! / using !ECMCOMMONUTIL_TOOL! [V1.27] >  !REPORT_LOG_PATH!\VMECMID_Latest.txt 2>&1
...
if defined LMS_EXTENDED_CONTENT (
	...
	echo     read host id's [using !ECMCOMMONUTIL_TOOL! DevMar2022] ...
	echo Read host id's [using !ECMCOMMONUTIL_TOOL! DevMar2022] ...         >> !REPORT_LOGFILE! 2>&1
	IF EXIST "!LMS_DOWNLOAD_PATH!\!ECMCOMMONUTIL_TOOL!" (
		rem log regular (non debug) output in general logfile
		echo Read version information [using !ECMCOMMONUTIL_TOOL! -v]:                  >  !ECMCOMMONUTIL_LOGFILE! 2>&1
		"!LMS_DOWNLOAD_PATH!\!ECMCOMMONUTIL_TOOL!" -v                                   >> !ECMCOMMONUTIL_LOGFILE! 2>&1
	...
	echo Read host id's [using !ECMCOMMONUTIL_TOOL! DevMar2022] SKIPPED, start script with option '/extend' to enable extended content.         >> !REPORT_LOGFILE! 2>&1
)
echo ==============================================================================           >> !REPORT_LOGFILE! 2>&1
...
if defined LMS_EXTENDED_CONTENT (
	...
	IF EXIST "!LMS_DOWNLOAD_PATH!\!ECMCOMMONUTIL_TOOL!" (
		...
		"!LMS_DOWNLOAD_PATH!\!ECMCOMMONUTIL_TOOL!" -l -f -d smbios                                     >  !CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_V1.25_smbios_Latest.txt 2>&1
		"!LMS_DOWNLOAD_PATH!\!ECMCOMMONUTIL_TOOL!" -l -f -d vm                                         >  !CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_V1.25_vm_Latest.txt 2>&1
		if exist "!CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_V1.25_smbios_Latest.txt" for /f "tokens=1,2 eol=@ delims==" %%A in ('type !CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_V1.25_smbios_Latest.txt ^|find /I "Smbios UUID"') do set "ECM_SMBIOS_UUID_4=%%B"
		if exist "!CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_V1.25_vm_Latest.txt"     for /f "tokens=1,2 eol=@ delims==:" %%A in ('type !CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_V1.25_vm_Latest.txt ^|findstr /I /B "FAMILY"') do if not "%%B" == " ERROR - Unavailable." set "ECM_VM_FAMILY_4=%%B"
		if exist "!CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_V1.25_vm_Latest.txt"     for /f "tokens=1,2 eol=@ delims==:" %%A in ('type !CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_V1.25_vm_Latest.txt ^|findstr /I /B "NAME"') do if not "%%B" == " ERROR - Unavailable." set "ECM_VM_NAME_4=%%B"
		if exist "!CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_V1.25_vm_Latest.txt"     for /f "tokens=1,2 eol=@ delims==:" %%A in ('type !CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_V1.25_vm_Latest.txt ^|findstr /I /B "UUID"') do if not "%%B" == " ERROR - Unavailable." set "ECM_VM_UUID_4=%%B"
		if exist "!CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_V1.25_vm_Latest.txt"     for /f "tokens=1,2 eol=@ delims==:" %%A in ('type !CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_V1.25_vm_Latest.txt ^|findstr /I /B "GENID"') do if not "%%B" == " ERROR - Unavailable." set "ECM_VM_GENID_4=%%B"
		
		echo Current ECM values, collected with !ECMCOMMONUTIL_TOOL! V1.25 ...          >> !REPORT_LOGFILE! 2>&1
		echo     ECM_VM_FAMILY=!ECM_VM_FAMILY_4! / ECM_VM_NAME=!ECM_VM_NAME_4! / ECM_VM_UUID=!ECM_VM_UUID_4! / ECM_SMBIOS_UUID=!ECM_SMBIOS_UUID_4! / ECM_VM_GENID=!ECM_VM_GENID_4!                      >> !REPORT_LOGFILE! 2>&1
		echo     ECM_VM_FAMILY=!ECM_VM_FAMILY_4! / ECM_VM_NAME=!ECM_VM_NAME_4! / ECM_VM_UUID=!ECM_VM_UUID_4! / ECM_SMBIOS_UUID=!ECM_SMBIOS_UUID_4! / ECM_VM_GENID=!ECM_VM_GENID_4!  at !DATE! / !TIME! / using !ECMCOMMONUTIL_TOOL! [V1.25] >> !REPORT_LOG_PATH!\VMECMID.txt 2>&1
		echo     ECM_VM_FAMILY=!ECM_VM_FAMILY_4! / ECM_VM_NAME=!ECM_VM_NAME_4! / ECM_VM_UUID=!ECM_VM_UUID_4! / ECM_SMBIOS_UUID=!ECM_SMBIOS_UUID_4! / ECM_VM_GENID=!ECM_VM_GENID_4!  at !DATE! / !TIME! / using !ECMCOMMONUTIL_TOOL! [V1.25] >  !REPORT_LOG_PATH!\VMECMID_Latest.txt 2>&1
...
if defined LMS_EXTENDED_CONTENT (
	...
	echo Read host id's [using !ECMCOMMONUTIL_TOOL! V1.23] ...         >> !REPORT_LOGFILE! 2>&1
	IF EXIST "!LMS_DOWNLOAD_PATH!\!ECMCOMMONUTIL_TOOL!" (
		rem log regular (non debug) output in general logfile
		echo Read version information [using !ECMCOMMONUTIL_TOOL! -v]:                  >  !ECMCOMMONUTIL_LOGFILE! 2>&1
		"!LMS_DOWNLOAD_PATH!\!ECMCOMMONUTIL_TOOL!" -v                                   >> !ECMCOMMONUTIL_LOGFILE! 2>&1
		...
		"!LMS_DOWNLOAD_PATH!\!ECMCOMMONUTIL_TOOL!" -l -f -d smbios                                     >  !CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_x64_n6_1.23_smbios_Latest.txt 2>&1
		"!LMS_DOWNLOAD_PATH!\!ECMCOMMONUTIL_TOOL!" -l -f -d vm                                         >  !CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_x64_n6_1.23_vm_Latest.txt 2>&1
		if exist "!CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_x64_n6_1.23_smbios_Latest.txt" for /f "tokens=1,2 eol=@ delims==" %%A in ('type !CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_x64_n6_1.23_smbios_Latest.txt ^|find /I "Smbios UUID"') do set "ECM_SMBIOS_UUID_3=%%B"
		if exist "!CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_x64_n6_1.23_vm_Latest.txt"     for /f "tokens=1,2 eol=@ delims==:" %%A in ('type !CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_x64_n6_1.23_vm_Latest.txt ^|findstr /I /B "FAMILY"') do if not "%%B" == " ERROR - Unavailable." set "ECM_VM_FAMILY_3=%%B"
		if exist "!CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_x64_n6_1.23_vm_Latest.txt"     for /f "tokens=1,2 eol=@ delims==:" %%A in ('type !CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_x64_n6_1.23_vm_Latest.txt ^|findstr /I /B "NAME"') do if not "%%B" == " ERROR - Unavailable." set "ECM_VM_NAME_3=%%B"
		...
		echo Current ECM values, collected with !ECMCOMMONUTIL_TOOL! V1.23 ...                                                                                                                                >> !REPORT_LOGFILE! 2>&1
		...
		echo     ECM_VM_FAMILY=!ECM_VM_FAMILY_3! / ECM_VM_NAME=!ECM_VM_NAME_3! / ECM_VM_UUID=!ECM_VM_UUID_3! / ECM_SMBIOS_UUID=!ECM_SMBIOS_UUID_3! / ECM_VM_GENID=!ECM_VM_GENID_3!  at !DATE! / !TIME! / using !ECMCOMMONUTIL_TOOL! [V1.23] >> !REPORT_LOG_PATH!\VMECMID.txt 2>&1
...
if defined LMS_EXTENDED_CONTENT (
	...
	IF EXIST "!LMS_DOWNLOAD_PATH!\!ECMCOMMONUTIL_TOOL!" (
		...
		"!LMS_DOWNLOAD_PATH!\!ECMCOMMONUTIL_TOOL!" -t vm                                >> !ECMCOMMONUTIL_LOGFILE! 2>&1
		echo -------------------------------------------------------                    >> !ECMCOMMONUTIL_LOGFILE! 2>&1
		echo Much more output available, check '!ECMCOMMONUTIL_LOGFILE!'                >> !REPORT_LOGFILE! 2>&1
		...
		"!LMS_DOWNLOAD_PATH!\!ECMCOMMONUTIL_TOOL!" -l -f -d device                                       >  !CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_device_Latest.txt 2>&1
		"!LMS_DOWNLOAD_PATH!\!ECMCOMMONUTIL_TOOL!" -l -f -d net                                          >  !CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_net_Latest.txt 2>&1
		"!LMS_DOWNLOAD_PATH!\!ECMCOMMONUTIL_TOOL!" -l -f -d smbios                                       >  !CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_smbios_Latest.txt 2>&1
		"!LMS_DOWNLOAD_PATH!\!ECMCOMMONUTIL_TOOL!" -l -f -d vm                                           >  !CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_vm_Latest.txt 2>&1
		if exist "!CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_smbios_Latest.txt" for /f "tokens=1,2 eol=@ delims==" %%A in ('type !CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_smbios_Latest.txt ^|find /I "Smbios UUID"') do set "ECM_SMBIOS_UUID_1=%%B"
		if exist "!CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_vm_Latest.txt"     for /f "tokens=1,2 eol=@ delims==:" %%A in ('type !CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_vm_Latest.txt ^|findstr /I /B "FAMILY"') do if not "%%B" == " ERROR - Unavailable." set "ECM_VM_FAMILY_1=%%B"
		if exist "!CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_vm_Latest.txt"     for /f "tokens=1,2 eol=@ delims==:" %%A in ('type !CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_vm_Latest.txt ^|findstr /I /B "NAME"') do if not "%%B" == " ERROR - Unavailable." set "ECM_VM_NAME_1=%%B"
		if exist "!CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_vm_Latest.txt"     for /f "tokens=1,2 eol=@ delims==:" %%A in ('type !CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_vm_Latest.txt ^|findstr /I /B "UUID"') do if not "%%B" == " ERROR - Unavailable." set "ECM_VM_UUID_1=%%B"
		if exist "!CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_vm_Latest.txt"     for /f "tokens=1,2 eol=@ delims==:" %%A in ('type !CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_vm_Latest.txt ^|findstr /I /B "GENID"') do if not "%%B" == " ERROR - Unavailable." set "ECM_VM_GENID_1=%%B"
		
		echo Current ECM values, collected with !ECMCOMMONUTIL_TOOL! V1.21...                                                                                                                 >> !REPORT_LOGFILE! 2>&1
		echo     ECM_VM_FAMILY=!ECM_VM_FAMILY_1! / ECM_VM_NAME=!ECM_VM_NAME_1! / ECM_VM_UUID=!ECM_VM_UUID_1! / ECM_SMBIOS_UUID=!ECM_SMBIOS_UUID_1! / ECM_VM_GENID=!ECM_VM_GENID_1!            >> !REPORT_LOGFILE! 2>&1
		echo     ECM_VM_FAMILY=!ECM_VM_FAMILY_1! / ECM_VM_NAME=!ECM_VM_NAME_1! / ECM_VM_UUID=!ECM_VM_UUID_1! / ECM_SMBIOS_UUID=!ECM_SMBIOS_UUID_1! / ECM_VM_GENID=!ECM_VM_GENID_1!  at !DATE! / !TIME! / using !ECMCOMMONUTIL_TOOL! [V1.21] >> !REPORT_LOG_PATH!\VMECMID.txt 2>&1
...
if defined LMS_EXTENDED_CONTENT (
	...
	IF EXIST "!LMS_DOWNLOAD_PATH!\!ECMCOMMONUTIL_TOOL!" (
		...
		"!LMS_DOWNLOAD_PATH!\!ECMCOMMONUTIL_TOOL!" -l -f -d smbios                                     >  !CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_1.19_smbios_Latest.txt 2>&1
		"!LMS_DOWNLOAD_PATH!\!ECMCOMMONUTIL_TOOL!" -l -f -d vm                                         >  !CHECKLMS_REPORT_LOG_PATH!\ecmcommonutil_1.19_vm_Latest.txt 2>&1
		...
		echo     ECM_VM_FAMILY=!ECM_VM_FAMILY_2! / ECM_VM_NAME=!ECM_VM_NAME_2! / ECM_VM_UUID=!ECM_VM_UUID_2! / ECM_SMBIOS_UUID=!ECM_SMBIOS_UUID_2! / ECM_VM_GENID=!ECM_VM_GENID_2!  at !DATE! / !TIME! / using !ECMCOMMONUTIL_TOOL! [V1.19] >> !REPORT_LOG_PATH!\VMECMID.txt 2>&1
	...
	IF EXIST "!ProgramFiles!\Siemens\SSU\bin" (
		...
		IF EXIST "!ProgramFiles!\Siemens\SSU\bin\SSUManager.exe" (
			...
			if not defined VC_REDIST_VERSION (
				echo !SHOW_RED!    ATTENTION: Relevant VC++ library not installed, SSU client will not run. !SHOW_NORMAL!
				echo ATTENTION: Relevant VC++ library not installed, SSU client will not run.                                    >> !REPORT_LOGFILE! 2>&1
			)
			echo SSU - Start SSU Manager ....                                                                                    >> !REPORT_LOGFILE! 2>&1
			start "Start SSU Manager" "!ProgramFiles!\Siemens\SSU\bin\SSUManager.exe"
			echo ---------------- Displays task list: for specific SSU processes                                                 >> !REPORT_LOGFILE! 2>&1
			tasklist /FI "IMAGENAME eq SSU*"                                                                                     >> !REPORT_LOGFILE! 2>&1
		)
		echo -------------------------------------------------------                                                             >> !REPORT_LOGFILE! 2>&1
