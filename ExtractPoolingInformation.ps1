...
# '20231114': Align further to common powershell architecture. Add own log file 'ExtractPoolingInformation.log'. Add 'ms' to log output.
#
$scriptVersion = '20231114'

# Function to print-out messages, including <date> and <time> information.
$scriptName = $MyInvocation.MyCommand.Name
$scriptLogFile = "$env:ProgramData\Siemens\LMS\Logs\ExtractPoolingInformation.log"  
